...
Write-Host "⏱️  Time: 20-30 minutes" -ForegroundColor Yellow
Write-Host ""
...
try {
    ...
    Write-Host "   ℹ️  Key pair already exists, using existing one" -ForegroundColor Cyan
}
...
Write-Host "🖥️  Step 3/7: Launching EC2 t2.micro instance (FREE TIER)..." -ForegroundColor Cyan
